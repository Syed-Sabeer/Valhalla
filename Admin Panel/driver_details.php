...
if (isset($_GET['id'])) {
    ...
    // Retrieve driver details from driver_details
    $selectQuery = "SELECT * FROM driver_details WHERE id = ?";
...
$selectVehicleQuery = "SELECT * FROM vehicle_details WHERE driver_id = ?";
