...
$totalRecordsQuery = "SELECT COUNT(*) AS total FROM users WHERE email LIKE ?";
...
<div class="contents">
    ...
    <input class="form-control me-sm-2 border-0 box-shadow-none" type="search" name="search" placeholder="Search by Email" aria-label="Search">
                        ...
                        <table class="table mb-0 table-borderless">
                            <thead>
                                ...
                                <th>
                                    ...
                                    <th>
                                        <span class="userDatatable-title">Total Bookings</span>
                                    </th>
                                    <th>
