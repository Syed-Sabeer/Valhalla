                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li>
                                        <a class="parent-item" href="">Fare Management</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    <li class="active">Add Fare
                                    </li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="txtFareKM"><label class="mdl-textfield__label" for="txtFareKM">Fare Per KM (in $)</label><span class="mdl-textfield__error">Number required!</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="txtMinFare"><label class="mdl-textfield__label" for="txtMinFare">Minimum Fare (in $)</label><span class="mdl-textfield__error">Number required!</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="txtMinDist"><label class="mdl-textfield__label" for="txtMinDist">Minimum Distance (in KM)</label><span class="mdl-textfield__error">Number required!</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="txtWaitFare"><label class="mdl-textfield__label" for="txtWaitFare">Waiting Fare (in $)</label><span class="mdl-textfield__error">Number required!</span>
                                            </div>
                                        </div>
