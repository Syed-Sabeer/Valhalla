...
<html lang="en">
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="nav-item active">
                                            <a href="charts_echarts.php" class="nav-link"><span class="title">eCharts</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li class="active">eCharts
                                    </li>
                                </ol>
                            </div>
                        </div><!-- start echart --><!-- bar chart start -->
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-topline-red">
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="row">
                                            <div id="echarts_line" class="chart-window"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- scatter chart start -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-topline-red">
                                    <div class="card-head">
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="row">
                                            <div id="echarts_scatter" class="chart-window"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- candle chart start -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-topline-red">
                                    <div class="card-head">
                                    ...
                                    <div class="card-body no-padding">
                                        <div class="row">
                                            <div id="echarts_candle" class="chart-window"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.min.js"></script><!-- echart -->
        <script src="assets/plugins/echarts/echarts.js"></script>
        <script src="assets/js/pages/chart/echart/echart-data.js"></script><!-- Common js-->
