...
<html lang="en">
    ...
    <head>
        ...
        <link href="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/4.3.1/css/bootstrap.min.css" rel="stylesheet" type="text/css"><!-- morris chart -->
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    <a href="javascript:;" class="nav-link nav-toggle"><i class="material-icons">timeline</i><span class="title">Charts</span><span class="selected"></span><span class="arrow open"></span></a>
                                    <ul class="sub-menu">
                                        <li class="nav-item">
                                            <a href="charts_echarts.php" class="nav-link"><span class="title">eCharts</span></a>
                                        </li>
                                        <li class="nav-item active">
                                            <a href="charts_morris.php" class="nav-link"><span class="title">Morris Charts</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li>
                                        <a class="parent-item" href="">Charts</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    <li class="active">Morris
                                    </li>
                                </ol>
                            </div>
                        </div><!-- morris chart start --><!-- start line chart -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-topline-red">
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="row">
                                            <div id="line_chart" class="chart-window"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- start area chart -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-topline-red">
                                    <div class="card-head">
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="row">
                                            <div id="area_chart" class="chart-window"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-topline-red">
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="row">
                                            <div id="bar_chart" class="chart-window"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- start donut chart -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-topline-red">
                                    <div class="card-head">
        ...
        <script src="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.min.js"></script><!-- morris chart -->
        <script src="assets/plugins/morris/morris.min.js"></script>
        <script src="assets/plugins/morris/raphael-min.js"></script>
        <script src="assets/js/pages/chart/morris/morris_chart_data.js"></script><!-- Common js-->
