                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="nav-item active">
                                            <a href="chat.php" class="nav-link"><span class="title">Chat</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="collapse collapse-xs collapse-sm show chat-page" id="open-chats">
                                            <div class="form-group mt-20 is-empty">
                                                <input type="text" value="" placeholder="Search..." class="form-control"><span class="material-input"></span>
                                            </div>
                                            <div class="list-unstyled" id="inbox">
                                                <div class="active">
                                                    <div class="media chat-list">
                                                        <div class="media-left thumb thumb-sm">
                                                            <img alt="" class="media-object chat-img" src="assets/img/user/user4.jpg">
                                                        </div>
                                                        <div class="media-body">
                                                            <p class="media-heading m-b-10">
                                                                <span class="text-strong">Sanjay Singh</span><span class="badge bg-danger">3</span><small class="pull-right">13:54, 24.01.2017</small>
                                                            </p><small class="message">Online</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="chat-inactive">
                                                    <div class="media chat-list">
                                                        <div class="media-left thumb thumb-sm">
                                                            <img alt="" class="media-object chat-img" src="assets/img/user/user5.jpg">
                                                        </div>
                                                        <div class="media-body">
                                                            <p class="media-heading m-b-10">
                                                                <span class="text-strong">Poonam Shah</span><span class="badge bg-infor">5</span><small class="pull-right">15:34, 22.01.2017</small>
                                                            </p><small class="message">Offline</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="chat-inactive">
                                                    <div class="media chat-list">
                                                        <div class="media-left thumb thumb-sm">
                                                            <img alt="" class="media-object chat-img" src="assets/img/user/user2.jpg">
                                                        </div>
                                                        <div class="media-body">
                                                            <p class="media-heading m-b-10">
                                                                <span class="text-strong">Janki Jadav</span><span class="badge bg-purple">4</span><small class="pull-right">16:12, 17.11.2017</small>
                                                            </p><small class="message">Online</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="chat-inactive">
                                                    <div class="media chat-list">
                                                        <div class="media-left thumb thumb-sm">
                                                            <img alt="" class="media-object chat-img" src="assets/img/user/user3.jpg">
                                                        </div>
                                                        <div class="media-body">
                                                            <p class="media-heading m-b-10">
                                                                <span class="text-strong">Jack Richart</span><span class="badge bg-blue">2</span><small class="pull-right">14:05, 24.11.2016</small>
                                                            </p><small class="message">Offline</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="chat-inactive">
                                                    <div class="media chat-list">
                                                        <div class="media-left thumb thumb-sm">
                                                            <img alt="" class="media-object chat-img" src="assets/img/user/user1.jpg">
                                                        </div>
                                                        <div class="media-body">
                                                            <p class="media-heading m-b-10">
                                                                <span>Ajay Pandya</span><small class="pull-right">13:26, 24.11.2016</small>
                                                            </p><small class="message">Online</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="chat-inactive">
                                                    <div class="media chat-list">
                                                        <div class="media-left thumb thumb-sm">
                                                            <img alt="" class="media-object chat-img" src="assets/img/user/user6.jpg">
                                                        </div>
                                                        <div class="media-body">
                                                            <p class="media-heading m-b-10">
                                                                <span>Meera Kumar</span><small class="pull-right">12:56, 24.11.2016</small>
                                                            </p><small class="message">Offline</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="chat-inactive">
                                                    <div class="media chat-list">
                                                        <div class="media-left thumb thumb-sm">
                                                            <img alt="" class="media-object chat-img" src="assets/img/user/user9.jpg">
                                                        </div>
                                                        <div class="media-body">
                                                            <p class="media-heading m-b-10">
                                                                <span>Sanjay Kumar</span><small class="pull-right">10:18, 24.11.2016</small>
                                                            </p><small class="message">Offline</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="chat-inactive">
                                                    <div class="media chat-list">
                                                        <div class="media-left thumb thumb-sm">
                                                            <img alt="" class="media-object chat-img" src="assets/img/user/user7.jpg">
                                                        </div>
                                                        <div class="media-body">
                                                            <p class="media-heading m-b-10">
                                                                <span>Priti Chopra</span><small class="pull-right">06:48, 24.11.2016</small>
                                                            </p><small class="message">Offline</small>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="row">
                                            <ul class="chat nice-chat chat-page small-slimscroll-style">
                                                <li class="in">
                                                    <img src="assets/img/user/user4.jpg" class="avatar" alt="">
                                                    <div class="message">
                                                        <span class="arrow"></span><a class="name" href="#">Sanjay Singh</a><span class="datetime">at Mar 12, 2014 6:12</span><span class="body">Lorem ipsum dolor sit amet,consectetuer adipiscing elit</span>
                                                    </div>
                                                </li>
                                                <li class="out">
                                                ...
                                                <li class="in">
                                                    <img src="assets/img/user/user4.jpg" class="avatar" alt="">
                                                    <div class="message">
                                                        <span class="arrow"></span><a class="name" href="#">Sanjay Singh</a><span class="datetime">at Mar 12, 2014 6:12</span><span class="body">aoreet dolore magna aliquam erat volutpat.</span>
                                                    </div>
                                                </li>
                                                <li class="out">
                                                    <img src="assets/img/dp.jpg" class="avatar" alt="">
                                            ...
                                            <div class="box-footer chat-box-submit">
                                                <form action="#" method="post">
                                                    <div class="input-group">
                                                        <input type="text" name="message" placeholder="Enter Chat" class="form-control"><span class="input-group-btn"><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-warning"><span class="input-group-btn">Send <i class="fa fa-paper-plane-o"></i></span></button></span>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
