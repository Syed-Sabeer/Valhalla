...
<html lang="en">
    ...
    <head>
        ...
        <link href="https://cdn.datatables.net/buttons/1.5.1/css/buttons.dataTables.min.css" rel="stylesheet" type="text/css"><!-- Material Design Lite CSS -->
        <link rel="stylesheet" href="assets/plugins/material/material.min.css">
        <link rel="stylesheet" href="assets/css/material_style.css"><!-- data tables --><!-- animation -->
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    <a href="#" class="nav-link nav-toggle"><i class="material-icons">local_taxi</i><span class="title">Trip</span><span class="selected"></span><span class="arrow open"></span></a>
                                    <ul class="sub-menu">
                                        <li class="nav-item">
                                            <a href="active_trips.php" class="nav-link"><span class="title">Active Trips</span></a>
                                        </li>
                                        <li class="nav-item active">
                                            <a href="completed_trips.php" class="nav-link"><span class="title">Completed Trips</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li>
                                        <a class="parent-item" href="">Trip</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    <li class="active">Completed Trips
                                    </li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <table id="tableExport">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="route_map.php" class="btn btn-tbl-delete btn-xs"><i class="fa fa-map-marker"></i></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            823 Lincoln Ave.Huntsville
                                                        </td>
                                                        <td>
                                                            3 Cedar Swamp Rd. Crown Point
                                                        </td>
                                                        <td>
                                                            11:34
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            7578 Vale Ave. Canfield
                                                        </td>
                                                        <td>
                                                            619 S. Wayne Ave. Fairport
                                                        </td>
                                                        <td>
                                                            07:39
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            568 Canal Street Toledo
                                                        </td>
                                                        <td>
                                                            892 Myers Ave. Des Moines
                                                        </td>
                                                        <td>
                                                            09:44
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            114 East Edgewood St. Lake Charles
                                                        </td>
                                                        <td>
                                                            7 Glen Ridge Street Fairmont
                                                        </td>
                                                        <td>
                                                            02:23
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            8373 S. Santa Clara Drive Mc Lean
                                                        </td>
                                                        <td>
                                                            12:34
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            37 La Sierra St. Mount Holly
                                                        </td>
                                                        <td>
                                                            425 Sage Street Leesburg
                                                        </td>
                                                        <td>
                                                            10:24
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            61 East Tallwood Ave. Cumming
                                                        </td>
                                                        <td>
                                                            8490 Middle River Ave. Roslindale
                                                        </td>
                                                        <td>
                                                            04:00
                                                        </td>
        ...
        <script src="assets/js/theme-color.js"></script><!-- data tables -->
        ...
        <script src="https://cdn.datatables.net/buttons/1.5.1/js/buttons.php5.min.js"></script>
        <script src="assets/js/pages/table/table_data.js"></script><!-- Material -->
