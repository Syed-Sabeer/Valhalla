...
<html lang="en">
    ...
    <head>
        ...
        <link href="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/4.3.1/css/bootstrap.min.css" rel="stylesheet" type="text/css"><!-- data tables -->
        <link href="assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.css" rel="stylesheet" type="text/css"><!-- Material Design Lite CSS -->
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="contact_list.php" class="nav-link"><span class="title">Contact List</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="card card-box">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-unbordered">
                                            ...
                                            <li class="list-group-item">Friends<a class="pull-right">450</a>
                                            </li>
                                            <li class="list-group-item">Family<a class="pull-right">345</a>
                                            </li>
                                            <li class="list-group-item">Office<a class="pull-right">172</a>
                                            </li>
                                            <li class="list-group-item">Social<a class="pull-right">432</a>
                                            </li>
                                        </ul><!-- END SIDEBAR USER TITLE --><!-- SIDEBAR BUTTONS -->
                                        <div class="profile-userbuttons">
                                            <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary">New Label</button>
                                            ...
                                            <table class="table table-hover table-checkable order-column full-width" id="example4">
                                                ...
                                                <tbody>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            345 Lancaster Lane, NJ
                                                        </td>
                                                        <td class="center">
                                                            <a href="edit_booking.php" class="btn btn-tbl-edit btn-xs"><i class="fa fa-pencil"></i></a><button class="btn btn-tbl-delete btn-xs"><i class="fa fa-trash-o"></i></button>
                                                        </td>
                                                    </tr>
                                                    <tr class="odd gradeX">
                                                        <td class="user-circle-img">
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            9264 E. Vermont Lane Maplewood, NJ
                                                        </td>
                                                        <td class="center">
                                                            <a href="edit_booking.php" class="btn btn-tbl-edit btn-xs"><i class="fa fa-pencil"></i></a><button class="btn btn-tbl-delete btn-xs"><i class="fa fa-trash-o"></i></button>
                                                        </td>
        ...
        <script src="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.min.js"></script><!-- data tables -->
        <script src="assets/plugins/datatables/jquery.dataTables.min.js"></script>
        <script src="assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.js"></script>
        <script src="assets/js/pages/table/table_data.js"></script><!-- Common js-->
