                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="contactus.php" class="nav-link"><span class="title">Contact Us</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            <div class="row m-b-20">
                                                <div class="col-sm-12">
                                                    ...
                                                    <p class="text-muted sub-title">
                                                        Redstartheme Group of Hotels, Resorts & Apartments welcomes your comments or questions. Please contact us at the numbers below..
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <!-- Contact form -->
                                                <div class="col-sm-6">
                                                    <form name="ajax-form" action="#" method="post" class="contact-form" data-parsley-validate="" novalidate="" id="ajax-form">
                                                ...
                                                <div class="col-sm-4 col-sm-offset-1">
                                                    <div class="contact-box">
                                                        <div class="contact-detail">
                                                            <i class="fa fa-map-marker"></i><span>A-304, Shyam appartment, Mahatma Gandhi Marg, Satellite</span>
                                                        </div>
                                                        <div class="contact-detail">
                                                            <i class="fa fa-mobile"></i><span><a href="mailto:(123)456-789-123">(123)456-789-123</a></span>
                                                        </div>
                                                        <div class="contact-detail">
                                                            <i class="fa fa-envelope"></i><span><a href="">support@example.com</a></span>
                                                        </div>
                                                    </div>
                                                </div><!-- end col -->
                                            </div>
