...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="assets/css/material_style.css"><!-- data tables -->
        <link href="assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.css" rel="stylesheet" type="text/css"><!-- animation -->
                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    <a href="#" class="nav-link nav-toggle"><i class="material-icons">person</i><span class="title">Drivers</span><span class="selected"></span><span class="arrow open"></span></a>
                                    <ul class="sub-menu">
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item active">
                                            <a href="driver_payment.php" class="nav-link"><span class="title">Driver Payment</span><span class="selected"></span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li class="active">Drivers Payment
                                    </li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <table class="table table-hover table-checkable order-column full-width" id="example4">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            <span class="label label-sm box-shadow-1 label-danger">Unpaid</span>
                                                        </td>
                                                        <td class="center">
                                                            22%
                                                        </td>
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            <span class="label label-sm box-shadow-1 label-warning">Unpaid</span>
                                                        </td>
                                                        <td class="center">
                                                            10%
                                                        </td>
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            <span class="label label-sm box-shadow-1 label-danger">Ubpaid</span>
                                                        </td>
                                                        <td class="center">
                                                            32%
                                                        </td>
