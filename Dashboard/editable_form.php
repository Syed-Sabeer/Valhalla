...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/plugins/bootstrap-editable/inputs-ext/address/address.css" rel="stylesheet" type="text/css"><!-- Material Design Lite CSS -->
        ...
        <link href="assets/plugins/summernote/summernote.css" rel="stylesheet"><!-- favicon  -->
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="editable_form.php" class="nav-link"><span class="title">Editor</span><span class="selected"></span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
        ...
        <script src="assets/js/pages/ui/animations.js"></script><!-- summernote -->
        <script src="assets/plugins/summernote/summernote.min.js"></script>
        <script src="assets/js/pages/summernote/summernote-data.js"></script><!-- end js include path -->
    </body>
</html>