                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    <a href="#" class="nav-link nav-toggle"><i class="material-icons">local_atm</i><span class="title">Fare Management</span><span class="selected"></span><span class="arrow open"></span></a>
                                    <ul class="sub-menu">
                                        <li class="nav-item">
                                            <a href="add_fare.php" class="nav-link"><span class="title">Add Fare</span></a>
                                        </li>
                                        <li class="nav-item active">
                                            <a href="fair_list.php" class="nav-link"><span class="title">Fail List</span><span class="selected"></span></a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li>
                                        <a class="parent-item" href="">Fair Management</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    <li class="active">Fair List
                                    </li>
                                </ol>
                            </div>
                        </div>
