                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    <a href="javascript:;" class="nav-link nav-toggle"><i class="material-icons">description</i><span class="title">Extra pages</span><span class="selected"></span><span class="arrow open"></span></a>
                                    <ul class="sub-menu">
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item active">
                                            <a href="faq.php" class="nav-link"><span class="title">Faq</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        <div class="panel-group accordion" id="accordion3">
                                            <div class="panel faq panel-default">
                                                <div class="panel-heading faq-heading panel-heading-gray">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_1">Q1. Anim pariatur cliche reprehenderit?</a>
                                                    </h4>
                                                </div>
                                                <div id="collapse_3_1" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        ...
                                                        </p><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-success"><i class="material-icons">thumb_up</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-pink"><i class="material-icons">thumb_down</i></button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel faq panel-default">
                                                <div class="panel-heading faq-heading panel-heading-gray">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_2">Completed my graduation in Arts from the well known?</a>
                                                    </h4>
                                                </div>
                                            ...
                                            <div class="panel faq panel-default">
                                                <div class="panel-heading faq-heading panel-heading-gray">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_3">Worked as Professor and Head of the department at Sarda Collage?</a>
                                                    </h4>
                                                </div>
                                            ...
                                            <div class="panel faq panel-default">
                                                <div class="panel-heading faq-heading panel-heading-gray">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_41">It has survived not only five centuries, but also the leap into?</a>
                                                    </h4>
                                                </div>
                                                <div id="collapse_3_41" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <p>
                                            ...
                                            <div class="panel faq panel-default">
                                                <div class="panel-heading faq-heading panel-heading-gray">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_12">Worked as Professor and Head of the department?</a>
                                                    </h4>
                                                </div>
                                            ...
                                            <div class="panel faq panel-default">
                                                <div class="panel-heading faq-heading panel-heading-gray">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_13">Q1. Anim pariatur cliche reprehenderit?</a>
                                                    </h4>
                                                </div>
                                            ...
                                            <div class="panel faq panel-default">
                                                <div class="panel-heading faq-heading panel-heading-gray">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_24">Completed my graduation in Arts from the well known?</a>
                                                    </h4>
                                                </div>
                                                <div id="collapse_3_24" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <p>
                                                            Completed my graduation in Arts from the well known and renowned institution of India – SARDAR PATEL ARTS COLLEGE, BARODA in 2000-01, which was affiliated to M.S. University. I ranker in University exams from the same university from 1996-01.
                                                        </p><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-success"><i class="material-icons">thumb_up</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-pink"><i class="material-icons">thumb_down</i></button>
                                            ...
                                            <div class="panel faq panel-default">
                                                <div class="panel-heading faq-heading panel-heading-gray">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_35">Worked as Professor and Head of the department at Sarda Collage?</a>
                                                    </h4>
                                                </div>
                                                <div id="collapse_3_35" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <p>
                                                            Completed my graduation in Arts from the well known and renowned institution of India – SARDAR PATEL ARTS COLLEGE, BARODA in 2000-01, which was affiliated to M.S. University. I ranker in University exams from the same university from 1996-01.
                                                        </p><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-success"><i class="material-icons">thumb_up</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-pink"><i class="material-icons">thumb_down</i></button>
                                            ...
                                            <div class="panel faq panel-default">
                                                <div class="panel-heading faq-heading panel-heading-gray">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_46">It has survived not only five centuries, but also the leap into?</a>
                                                    </h4>
                                                </div>
                                                <div id="collapse_3_46" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <p>
                                                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen.
                                                        </p><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-success"><i class="material-icons">thumb_up</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-pink"><i class="material-icons">thumb_down</i></button>
                                            ...
                                            <div class="panel faq panel-default">
                                                <div class="panel-heading faq-heading panel-heading-gray">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_17">Worked as Professor and Head of the department?</a>
                                                    </h4>
                                                </div>
                                                <div id="collapse_3_17" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <p>
                                                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.
                                                        </p><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-success"><i class="material-icons">thumb_up</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-pink"><i class="material-icons">thumb_down</i></button>
