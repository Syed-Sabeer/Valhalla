                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="nav-item active">
                                            <a href="fontawesome_icons.php" class="nav-link"><span class="title">Font Awesome</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-pane active fontawesome-demo" id="tab1">
                                            ...
                                            <div class="row fontawesome-icon-list">
                                                ...
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                                    <i class="fa fa-intersex"></i>fa-intersex <span class="text-muted">(alias)</span>
                                                </div>
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                            ...
                                            <div class="alert alert-success">
                                                <ul class="fa-ul">
                                                    <li>
                                                        <i class="fa fa-info-circle fa-lg fa-li"></i>These icons work great with the <code>fa-spin</code>class.
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="row fontawesome-icon-list">
                                            ...
                                            <div class="row fontawesome-icon-list mg-bottom-lg">
                                                ...
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                                    <i class="fa fa-facebook-f"></i>fa-facebook-f <span class="text-muted">(alias)</span>
                                                </div>
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                                ...
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                                    <i class="fa fa-gittip"></i>fa-gittip <span class="text-muted">(alias)</span>
                                                </div>
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                                ...
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                                    <i class="fa fa-y-combinator-square"></i>fa-y-combinator-square <span class="text-muted">(alias)</span>
                                                </div>
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                                    <i class="fa fa-yahoo"></i>fa-yahoo
                                                </div>
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                                    <i class="fa fa-yc"></i>fa-yc <span class="text-muted">(alias)</span>
                                                </div>
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                                    <i class="fa fa-yc-square"></i>fa-yc-square <span class="text-muted">(alias)</span>
                                                </div>
                                                <div class="fa-item col-md-3 col-sm-4 col-12">
                                            ...
                                            <div class="alert alert-success">
                                                <ul class="mg-bottom-none padding-left-lg">
                                                    ...
                                                    <li>Brand icons should only be used to represent the company or product to which they refer.
                                                    </li>
                                                    <li class="strong">Please do not use brand logos for any purpose except to represent that particular brand or service.
                                                    </li>
                                                </ul>
                                            </div>
                                            <h3 class="page-header">
