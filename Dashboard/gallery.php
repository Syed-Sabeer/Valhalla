...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/css/pages/animate_page.css" rel="stylesheet"><!-- gallery -->
        <link href="assets/plugins/light-gallery/css/lightgallery.css" rel="stylesheet"><!-- Theme Styles -->
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    <a href="#" class="nav-link nav-toggle"><i class="material-icons">grain</i><span class="title">Apps</span><span class="selected"></span><span class="arrow open"></span></a>
                                    <ul class="sub-menu">
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item active">
                                            <a href="gallery.php" class="nav-link"><span class="title">Gallery</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="card-body row">
                                        <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/1.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-1.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/2.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-2.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/3.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-3.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/4.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-4.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/5.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-5.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/6.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-6.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/7.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-7.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/8.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-8.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/9.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-9.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/10.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-10.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/11.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-11.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/12.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-12.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/13.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-13.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/14.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-14.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/15.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-15.jpg" alt=""></a>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-20">
                                                <a href="assets/img/image-gallery/5.jpg" data-sub-html="Demo Description"><img class="img-fluid img-thumbnail" src="assets/img/image-gallery/thumb/thumb-5.jpg" alt=""></a>
                                            </div>
        ...
        <script src="assets/js/pages/ui/animations.js"></script><!-- gallery -->
        <script src="assets/plugins/light-gallery/js/lightgallery-all.js"></script><!-- Light Gallery Plugin Js -->
        <script src="assets/plugins/light-gallery/js/image-gallery.js"></script><!-- end js include path -->
    </body>
</html>