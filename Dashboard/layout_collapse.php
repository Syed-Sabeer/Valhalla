...
<html lang="en">
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white sidemenu-closed white-sidebar-color logo-white">
                ...
                <div class="sidebar-container">
                    <div class="sidemenu-container navbar-collapse collapse fixed-menu">
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed sidemenu-closed p-t-20">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="layout_collapse.php" class="nav-link"><span class="title">Collapse Menu</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
