...
<html lang="en">
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md page-full-width header-white white-sidebar-color logo-white">
        <div class="page-wrapper">
                    ...
                    <div class="hor-menu hidden-sm hidden-xs">
                        <ul class="nav navbar-nav">
                            <li class="mega-menu-dropdown">
                                <a href="" class="dropdown-toggle"><i class="material-icons">dashboard</i>Dashboard <i class="fa fa-angle-down"></i><span class="arrow"></span></a>
                            ...
                            <li class="classic-menu-dropdown mega-menu-dropdown">
                                <a href="" class="megamenu-dropdown" data-close-others="true"><i class="material-icons">assignment</i>Manage <i class="fa fa-angle-down"></i><span class="arrow"></span></a>
                            ...
                            <li class="mega-menu-dropdown">
                                <a href="" class="dropdown-toggle"><i class="material-icons">email</i>Email <i class="fa fa-angle-down"></i><span class="arrow"></span></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <div class="mega-menu-content">
                                            <div class="row">
                            ...
                            <li class="mega-menu-dropdown">
                                <a href="" class="dropdown-toggle"><i class="material-icons">grain</i>Apps <i class="fa fa-angle-down"></i><span class="arrow"></span></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <div class="mega-menu-content">
                                            <div class="row">
                            ...
                            <li class="mega-menu-dropdown">
                                <a href="" class="dropdown-toggle"><i class="material-icons">dvr</i>UI Elements <i class="fa fa-angle-down"></i><span class="arrow"></span></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <div class="mega-menu-content">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <ul class="mega-menu-submenu">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="icons.php" class="nav-link"><span class="title">Icons</span></a>
                                                        </li>
                                                        <li class="nav-item">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="calendar.php" class="nav-link"><span class="title">Calender</span></a>
                                                        </li>
                                                        <li class="nav-item">
                            ...
                            <li class="mega-menu-dropdown active">
                                <a href="" class="dropdown-toggle"><i class="material-icons">desktop_mac</i>Layout <i class="fa fa-angle-down"></i><span class="selected"></span><span class="arrow open"></span></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <div class="mega-menu-content">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <ul class="mega-menu-submenu">
                                                        ...
                                                        <li class="nav-item active">
                                                            <a href="layout_full_width.php" class="nav-link"><span class="title">Full Width</span><span class="selected"></span></a>
                                                        </li>
                                                        <li class="nav-item">
                            ...
                            <li class="mega-menu-dropdown">
                                <a href="" class="dropdown-toggle"><i class="material-icons">subtitles</i>Forms <i class="fa fa-angle-down"></i><span class="arrow"></span></a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                            ...
                            <li class="mega-menu-dropdown">
                                <a href="" class="dropdown-toggle"><i class="material-icons">list</i>Data Tables <i class="fa fa-angle-down"></i><span class="arrow"></span></a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                            ...
                            <li class="mega-menu-dropdown">
                                <a href="" class="dropdown-toggle"><i class="material-icons">timeline</i>Charts <i class="fa fa-angle-down"></i><span class="arrow"></span></a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                            ...
                            <li class="mega-menu-dropdown">
                                <a href="" class="dropdown-toggle"><i class="material-icons">description</i>Extra pages <i class="fa fa-angle-down"></i><span class="arrow"></span></a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                    ...
                    <div class="sidemenu-container navbar-collapse collapse fixed-menu">
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    <a href="#" class="nav-link nav-toggle"><i class="material-icons">desktop_mac</i><span class="title">Layout</span><span class="selected"></span><span class="arrow open"></span></a>
                                    <ul class="sub-menu">
                                        <li class="nav-item">
                                            <a href="layout_boxed.php" class="nav-link"><span class="title">Boxed</span></a>
                                        </li>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    </div><!-- Chart end --><!-- start Payment Details -->
                    <div class="row">
                                            ...
                                            <table class="table display product-overview mb-30" id="support_table5">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#" class="btn btn-tbl-edit btn-xs"><i class="fa fa-pencil"></i></a><button class="btn btn-tbl-delete btn-xs"><i class="fa fa-trash-o"></i></button>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <div class="col-md-8 col-sm-8">
                                                        ...
                                                        <div class="details">
                                                            <div class="title">
                                                                ...
                                                                <p class="rating-text">
                                                                    Staff was good nd i'll come again
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-8 col-sm-8">
                                                        ...
                                                        <div class="details">
                                                            <div class="title">
                                                                ...
                                                                <p class="rating-text">
                                                                    The price I received was good value.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        </div><!-- end footer --><!-- start js include path -->
        ...
        <script src="assets/js/pages/sparkline/sparkline-data.js"></script><!-- Common js-->
        ...
        <script src="assets/js/pages/ui/animations.js"></script><!-- morris chart -->
        <script src="assets/plugins/morris/morris.min.js"></script>
        <script src="assets/plugins/morris/raphael-min.js"></script>
        <script src="assets/js/pages/chart/morris/morris_home_data.js"></script><!-- google map -->
        <script src="assets/plugins/modernizr/modernizr.min.js"></script>
        <script src="http://cdn.dedemao.com/maps/api/js?key=AIzaSyAtPIcsjNx-GEuJDPmiXOVyB3G9k1eulX0&amp;callback=initMap" async defer></script>
        <script src="assets/js/pages/map/gmap-home.js"></script><!-- end js include path -->
    </body>
</html>