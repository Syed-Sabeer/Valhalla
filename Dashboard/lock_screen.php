            ...
            <div class="container-login100 page-background">
                <div class="wrap-login100">
                    <form class="login100-form validate-form">
                        <span class="login100-form-logo"><img src="assets/img/dp.jpg" class="imgroundcorners" alt="John Doe"></span><span class="login100-form-title p-t-27">John Deo</span>
                        ...
                        <div class="text-center p-t-27">
                            <a class="txt1" href="login.php">sign in as a different user</a>
                        </div>
                    </form>
                </div>
            </div>
