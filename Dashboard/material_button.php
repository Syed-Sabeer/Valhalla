            ...
            <div class="page-container">
                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    <a href="#" class="nav-link nav-toggle"><i class="material-icons">store</i><span class="title">Material Elements</span><span class="selected"></span><span class="arrow open"></span></a>
                                    <ul class="sub-menu">
                                        <li class="nav-item active">
                                            <a href="material_button.php" class="nav-link"><span class="title">Buttons</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="page-content-wrapper">
                    <div class="page-content">
                        ...
                        </div><!-- add content here --><!-- start page content -->
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card-box">
                                    <div class="card-head">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-default">Default</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-primary">Primary</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-success">Success</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-info">Info</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-warning">Warning</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-danger">Danger</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-pink">Pink</button><br>
                                                <h4 class="sub-title">
                                                    Disable buttons
                                                </h4>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-default" disabled>Default</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-primary" disabled>Primary</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-success" disabled>Success</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-info" disabled>Info</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-warning" disabled>Warning</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-danger" disabled>Danger</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-pink" disabled>Pink</button><br>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-default">Default</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary">Primary</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-success">Success</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-info">Info</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-warning">Warning</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-danger">Danger</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-pink">Pink</button><br>
                                                <h4 class="sub-title">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-default" disabled>Default</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" disabled>Primary</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-success" disabled>Success</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-info" disabled>Info</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-warning" disabled>Warning</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-danger" disabled>Danger</button><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-pink" disabled>Pink</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-default"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-primary"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-success"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-info"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-warning"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-danger"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-pink"><i class="material-icons">add</i></button><br>
                                                <h4 class="sub-title">
                                                    Disable buttons
                                                </h4>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-default" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-primary" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-success" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-info" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-warning" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-danger" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab margin-right-10 btn-pink" disabled><i class="material-icons">add</i></button><br>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-default"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-primary"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-success"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-info"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-warning"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-danger"><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-pink"><i class="material-icons">add</i></button><br>
                                                <h4 class="sub-title">
                                                    Disable Rounded Buttons
                                                </h4>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-default" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-primary" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-success" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-info" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-warning" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-danger" disabled><i class="material-icons">add</i></button><button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect margin-right-10 btn-pink" disabled><i class="material-icons">add</i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Flat button --> <button class="mdl-button mdl-js-button margin-right-10">Button</button><!-- Flat button with ripple --> <button class="mdl-button mdl-js-button mdl-js-ripple-effect margin-right-10">Button</button><!-- Disabled flat button --> <button class="mdl-button mdl-js-button margin-right-10" disabled>Button</button><br>
                                                <h4 class="sub-title">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Primary-colored flat button --> <button class="mdl-button mdl-js-button mdl-button--primary margin-right-10">Button</button><!-- Accent-colored flat button --> <button class="mdl-button mdl-js-button mdl-button--accent margin-right-10">Button</button><br>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Icon button --><button class="mdl-button mdl-js-button mdl-button--icon margin-right-10"><i class="material-icons">mood</i></button><!-- Colored icon button --><button class="mdl-button mdl-js-button mdl-button--icon mdl-button--colored margin-right-10"><i class="material-icons">mood</i></button><br>
                                                <h4 class="sub-title">
                                                    Mini FAB button
                                                </h4>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- Mini FAB button --><button class="mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab margin-right-10"><i class="material-icons">add</i></button><!-- Colored mini FAB button --><button class="mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab mdl-button--colored margin-right-10"><i class="material-icons">add</i></button><br>
                                            </div>
                                        </div>
                                    </div>
                                </div>
