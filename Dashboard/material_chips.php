                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="material_chips.php" class="nav-link"><span class="title">Chips</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="col-lg-4">
                                            <!-- Deletable Contact Chip --><span class="mdl-chip mdl-chip--contact mdl-chip--deletable"><img alt="#" class="mdl-chip__contact" src="assets/img/dp.jpg"><span class="mdl-chip__text">Deletable Contact Chip</span><a href="#" class="mdl-chip__action"><i class="material-icons">cancel</i></a></span>
                                        </div>
