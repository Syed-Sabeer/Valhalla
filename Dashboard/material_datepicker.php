                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="material_datepicker.php" class="nav-link"><span class="title">DatePicker</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="col-lg-6 p-t-20">
                                            <div class="form-control-wrapper">
                                                <input type="text" id="time" class="floating-label mdl-textfield__input" placeholder="Time">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="col-lg-6 p-t-20">
                                            <div class="form-control-wrapper">
                                                <input type="text" id="date-format" class="floating-label mdl-textfield__input" placeholder="Date Time Picker">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="col-lg-6 p-t-20">
                                            <div class="form-control-wrapper">
                                                <input type="text" id="date-fr" class="floating-label mdl-textfield__input" value="18/03/2015 08:00" placeholder="Date de dꣵt">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="col-lg-6 p-t-20">
                                            <div class="form-control-wrapper">
                                                <input type="text" id="min-date" class="floating-label mdl-textfield__input" placeholder="Start Date">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-6 p-t-20">
                                            <div class="row">
                                                <div class="col-md-12 p-t-20">
                                                    <div class="form-control-wrapper">
                                                        <input type="text" id="date-start" class="floating-label mdl-textfield__input" placeholder="Start Date">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 p-t-20">
                                                    <div class="form-control-wrapper">
                                                        <input type="text" id="date-end" class="floating-label mdl-textfield__input" placeholder="End Date">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
