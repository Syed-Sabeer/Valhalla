...
<html lang="en">
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="material_loading.php" class="nav-link"><span class="title">Loading</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
        ...
        <script src="assets/js/pages/material-loading/material-loading.js"></script><!-- end js include path -->
    </body>
</html>