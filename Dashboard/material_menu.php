                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"><img alt="" class="img-circle" src="assets/img/dp.jpg"><span class="username username-hide-on-mobile">Maria Smith</span><i class="fa fa-angle-down"></i></a>
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="material_menu.php" class="nav-link"><span class="title">Menu</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-js-ripple-effect" data-mdl-for="demo-menu-lower-left">
                                            <li class="mdl-menu__item">Item #1
                                            </li>
                                            <li class="mdl-menu__item">Item #2
                                            </li>
                                            <li class="mdl-menu__item">Item #3
                                            </li>
                                        </ul>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="menuBar">
                                            <button id="demo_menu-lower-right" class="mdl-button mdl-js-button mdl-button--icon pull-right" data-upgraded=",MaterialButton"><i class="material-icons">more_vert</i></button>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="menuBar">
                                            <button id="demo_menu-top-left" class="mdl-button mdl-js-button mdl-button--icon" data-upgraded=",MaterialButton"><i class="material-icons">more_vert</i></button>
                                            <ul class="mdl-menu mdl-menu--top-left mdl-js-menu mdl-js-ripple-effect" data-mdl-for="demo_menu-top-left">
                                                <li class="mdl-menu__item">Item #1
                                                </li>
                                                <li class="mdl-menu__item">Item #2
                                                </li>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="menuBar">
                                            <button id="demo_menu-top-right" class="mdl-button mdl-js-button mdl-button--icon pull-right" data-upgraded=",MaterialButton"><i class="material-icons">more_vert</i></button>
                                            <ul class="mdl-menu mdl-menu--top-right mdl-js-menu mdl-js-ripple-effect" data-mdl-for="demo_menu-top-right">
                                                <li class="mdl-menu__item">Item #1
                                                </li>
                                                <li class="mdl-menu__item">Item #2
                                                </li>
