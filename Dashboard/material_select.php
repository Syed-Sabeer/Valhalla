...
<html lang="en">
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="material_select.php" class="nav-link"><span class="title">Select Item</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="card-body row">
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth select-width">
                                                <input class="mdl-textfield__input" type="text" id="sample1" value="India" readonly tabindex="-1"><label for="sample1" class="mdl-textfield__label">Country</label>
                                                <ul data-mdl-for="sample1" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                                                    <li class="mdl-menu__item">Shrilanka
                                                    </li>
                                                    <li class="mdl-menu__item">India
                                                    </li>
                                                    <li class="mdl-menu__item">Germany
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <script src="assets/js/pages/material_select/getmdl-select.js"></script><!-- Material -->
