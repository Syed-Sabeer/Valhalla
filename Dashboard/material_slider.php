                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="material_slider.php" class="nav-link"><span class="title">Slider</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <h5 class="sub-title">
                                            Default Slider
                                        </h5><input id="slider1" class="mdl-slider mdl-js-slider" type="range" min="0" max="100" value="0" tabindex="0">
                                        <h5 class="sub-title">
                                            Slider with initial value
                                        </h5><input id="slider2" class="mdl-slider mdl-js-slider" type="range" min="0" max="100" value="25" tabindex="0" oninput="showMessage(this.value)" onchange="showMessage(this.value)">
                                        <h5 class="sub-title">
                                            Disabled Slider
                                        </h5><input id="slider3" class="mdl-slider mdl-js-slider" type="range" min="0" max="100" value="25" tabindex="0" step="2" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
