                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="material_tab.php" class="nav-link"><span class="title">Tabs</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        <div class="mdl-tabs mdl-js-tabs">
                                            <div class="mdl-tabs__tab-bar">
                                                <a href="#tab1-panel" class="mdl-tabs__tab is-active">Tab 1</a><a href="#tab2-panel" class="mdl-tabs__tab">Tab 2</a><a href="#tab3-panel" class="mdl-tabs__tab">Tab 3</a>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mdl-tabs mdl-js-tabs">
                                            <div class="mdl-tabs__tab-bar tab-left-side">
                                                <a href="#tab4-panel" class="mdl-tabs__tab is-active">Tab 1</a><a href="#tab5-panel" class="mdl-tabs__tab">Tab 2</a><a href="#tab6-panel" class="mdl-tabs__tab">Tab 3</a>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <div class="mdl-tabs mdl-js-tabs">
                                            <div class="mdl-tabs__tab-bar tab-right-side">
                                                <a href="#tab7-panel" class="mdl-tabs__tab is-active">Tab 1</a><a href="#tab8-panel" class="mdl-tabs__tab">Tab 2</a><a href="#tab9-panel" class="mdl-tabs__tab">Tab 3</a>
                                            </div>
                                            <div class="mdl-tabs__panel is-active p-t-20" id="tab7-panel">
                                                <p>
                                                    Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent.
                                                </p>
                                                <p>
