                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="material_tables.php" class="nav-link"><span class="title">Tables</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <table class="mdl-data-table ml-table-bordered mdl-js-data-table mdl-data-table--selectable is-upgraded">
                                            <thead>
                                                <tr>
                                                    <th class="mdl-data-table__cell--non-numeric">
                                                        Name
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <table class="mdl-data-table ml-table-striped ml-table-bordered mdl-js-data-table mdl-data-table--selectable is-upgraded">
                                            <thead>
                                                <tr>
                                                    <th class="mdl-data-table__cell--non-numeric">
                                                        Name
