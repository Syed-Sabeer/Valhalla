...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/css/pages/animate_page.css" rel="stylesheet"><!-- pricing -->
        <link rel="stylesheet" href="assets/css/pages/pricing.css"><!-- Theme Styles -->
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="pricing.php" class="nav-link"><span class="title">Pricing</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                                    ...
                                                    <div class="pricing-grid1">
                                                        ...
                                                        <div class="price-bg">
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="#">Wallet Cashback Offer</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#">Free Cancellation</a>
                                                                </li>
