...
<html lang="en">
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="route_map.php" class="nav-link"><span class="title">Route Map</span><span class="selected"></span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    Shyamal Cross Rd, Ahmedabad, Gujarat, India
                                                </div><!--.col-md-9-->
                                            </div><!--.row-->
                                            <div class="row">
                                                <div class="col-md-3">
        ...
        <script src="assets/js/pages/map/gmap-route.js"></script><!-- Common js-->
