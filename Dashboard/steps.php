...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/css/pages/animate_page.css" rel="stylesheet"><!-- steps -->
        <link rel="stylesheet" href="assets/css/pages/steps.css"><!-- Theme Styles -->
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    <a href="javascript:;" class="nav-link nav-toggle"><i class="material-icons">subtitles</i><span class="title">Forms</span><span class="active open"></span><span class="selected"></span></a>
                                    <ul class="sub-menu">
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item active">
                                            <a href="steps.php" class="nav-link"><span class="title">Wizard</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <form id="example-advanced-form" action="#" name="example-advanced-form">
                                            <h3>
                                                Account Information
                                            </h3>
                                            <fieldset>
                                                <div class="col-lg-12 p-t-20">
                                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                        <input class="mdl-textfield__input" type="text" pattern="[A-Z,a-z]*" name="userName" id="username" required=""><label class="mdl-textfield__label" for="username">Username</label><span class="mdl-textfield__error">Enter User Name!</span>
                                                    </div>
                                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                        <input class="mdl-textfield__input" type="password" id="password-2" name="password" required=""><label class="mdl-textfield__label" for="password-2">Password</label><span class="mdl-textfield__error">Enter Valid Password!</span>
                                                    </div>
                                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                        <input class="mdl-textfield__input" type="password" id="confirm-2" name="confirm" required=""><label class="mdl-textfield__label">Confirm Password</label><span class="mdl-textfield__error">Enter Valid Password!</span>
                                                    </div>
                                                </div>
                                            </fieldset>
                                            <h3>
                                            ...
                                            <fieldset>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                    <input class="mdl-textfield__input" type="text" id="name-2" name="name" required=""><label class="mdl-textfield__label">First name *</label><span class="mdl-textfield__error">Enter First Name!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                    <input class="mdl-textfield__input" type="text" id="surname-2" name="surname" required=""><label class="mdl-textfield__label">Last name *</label><span class="mdl-textfield__error">Enter Last Name!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                    <input class="mdl-textfield__input" type="email" id="email-2" name="email" required=""><label class="mdl-textfield__label">Email *</label><span class="mdl-textfield__error">Enter Valid Email!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                    <input class="mdl-textfield__input" type="number" id="age-2" name="age" required=""><label class="mdl-textfield__label">Age *</label><span class="mdl-textfield__error">Enter Valid Age!</span>
                                                </div>
                                            </fieldset>
                                            <h3>
                                                Finish
                                            ...
                                            <fieldset>
                                                <div class="col-lg-12 p-t-20">
                                                    <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="checkbox-1"><input type="checkbox" id="checkbox-1" name="acceptTerms" class="mdl-checkbox__input" required=""><span class="mdl-checkbox__label">I agree with the Terms and Conditions.</span></label>
                                                </div>
                                            </fieldset>
                                        </form>
                                    </div>
        ...
        <script src="assets/plugins/jquery-validation/js/jquery.validate.min.js"></script><!-- bootstrap -->
        <script src="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.min.js"></script><!-- steps -->
        <script src="assets/plugins/steps/jquery.steps.js"></script>
        <script src="assets/js/pages/steps/steps-data.js"></script><!-- Common js-->
