...
<html lang="en">
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="support.php" class="nav-link"><span class="title">Support</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="overview-panel purple">
                                                        ...
                                                        <div class="value white">
                                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="1576">
                                                                0
                                                            </p>
                                                            <p>
                                                                Total Tickets
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="overview-panel deepPink-bgcolor">
                                                        ...
                                                        <div class="value white">
                                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="956">
                                                                0
                                                            </p>
                                                            <p>
                                                                Respond
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="overview-panel orange">
                                                        ...
                                                        <div class="value white">
                                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="856">
                                                                0
                                                            </p>
                                                            <p>
                                                                Resolved
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="overview-panel blue-bgcolor">
                                                        ...
                                                        <div class="value white">
                                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="134">
                                                                0
                                                            </p>
                                                            <p>
                                                                Pending
                                        ...
                                        <div class="row p-b-20">
                                            <div class="col-md-6 col-sm-6 col-6">
                                                <div class="btn-group">
                                                    <button id="addRow1" class="btn btn-info">Add New <i class="fa fa-plus"></i></button>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-6">
                                                <div class="btn-group pull-right">
                                                    <button class="btn deepPink-bgcolor btn-outline dropdown-toggle" data-toggle="dropdown">Tools <i class="fa fa-angle-down"></i></button>
        ...
        <script src="assets/plugins/counterup/jquery.counterup.min.js"></script><!-- bootstrap -->
