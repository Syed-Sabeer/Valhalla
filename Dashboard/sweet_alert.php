...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="assets/plugins/sweet-alert/sweetalert.min.css"><!-- Theme Styles -->
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="sweet_alert.php" class="nav-link"><span class="title">Sweet Alert</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <table class="table btn-sweetalert">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="basic">CLICK ME</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="middle-align">
                                                    ...
                                                    <td>
                                                        <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="with-title">CLICK ME</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="middle-align">
                                                    ...
                                                    <td>
                                                        <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="success">CLICK ME</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="middle-align">
                                                    ...
                                                    <td>
                                                        <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="confirm">CLICK ME</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="middle-align">
                                                    ...
                                                    <td>
                                                        <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="cancel">CLICK ME</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="middle-align">
                                                    ...
                                                    <td>
                                                        <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="with-custom-icon">CLICK ME</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="middle-align">
                                                    ...
                                                    <td>
                                                        <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="autoclose-timer">CLICK ME</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="middle-align">
                                                    ...
                                                    <td>
                                                        <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="html-message">CLICK ME</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="middle-align">
                                                        A replacement for the <b>prompt</b>function
                                                    </td>
                                                    <td>
                                                        <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="prompt">CLICK ME</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="middle-align">
                                                    ...
                                                    <td>
                                                        <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="ajax-loader">CLICK ME</button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
        ...
        <script src="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.min.js"></script><!-- Sweet Alert -->
        <script src="assets/plugins/sweet-alert/sweetalert.min.js"></script>
        <script src="assets/js/pages/sweet-alert/sweet-alert-data.js"></script><!-- Common js-->
