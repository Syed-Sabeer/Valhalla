                        ...
                        <div id="remove-scroll">
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    <a href="javascript:;" class="nav-link nav-toggle"><i class="material-icons">list</i><span class="title">Data Tables</span><span class="selected"></span><span class="arrow open"></span></a>
                                    <ul class="sub-menu">
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item active">
                                            <a href="table_data.php" class="nav-link"><span class="title">Tables With Sourced Data</span><span class="selected"></span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-heading m-t-20">
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li>
                                        <a class="parent-item" href="">Tables</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    <li class="active">Table With Data
                                    </li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-box">
                                    ...
                                    <div class="card-body">
                                        <table id="dataTable" class="display full-width"></table>
                                    </div>
                                </div>
                            </div>
                        </div>
