...
<html lang="en">
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="tabs_accordions_navs.php" class="nav-link"><span class="title">Tabs & Accordions</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li class="active">Tabs & Accordions
                                    </li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <div class="borderBox-body">
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="borderBox_tab1">
                                                ...
                                                <p></p>
                                                <div class="btn-group">
                                                    <a class="btn purple" href="javascript:;" data-toggle="dropdown"><i class="fa fa-user"></i>Settings <i class="fa fa-angle-down"></i></a>
                                                    <ul class="dropdown-menu bottom-up">
                                                        <li>
                                                            <a href="javascript:;"><i class="fa fa-plus"></i>Add</a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:;"><i class="fa fa-trash-o"></i>Edit</a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:;"><i class="fa fa-times"></i>Delete</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
                                            ...
                                            <div class="tab-pane" id="borderBox_tab2">
                                                ...
                                                <p>
                                                    <a class="btn red" href="tabs_accordions_navs.php#borderBox_tab2" target="_blank">Click here</a>
                                                </p>
                                            </div>
                                            <div class="tab-pane" id="borderBox_tab3">
                                                ...
                                                <p>
                                                    <a class="btn blue-bgcolor" href="tabs_accordions_navs.php#borderBox_tab3" target="_blank">Click here</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="panel tab-border card-box">
                                    <header class="panel-heading panel-heading-gray custom-tab">
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a href="#home-2" data-toggle="tab"><i class="fa fa-home"></i></a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#about-2" data-toggle="tab" class="active"><i class="fa fa-user"></i>About</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#contact-2" data-toggle="tab"><i class="fa fa-envelope-o"></i>Contact</a>
                                            </li>
                                        </ul>
                                    </header>
                                    <div class="panel-body">
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="collapse_3_2" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        ...
                                                        <p>
                                                            <a class="btn blue-bgcolor" href="tabs_accordions_navs.php#collapse_3_2" target="_blank">Activate this section via URL</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel panel-default">
                                                ...
                                                <div id="collapse_3_3" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        ...
                                                        <p>
                                                            <a class="btn green-bgcolor" href="tabs_accordions_navs.php#collapse_3_3" target="_blank">Activate this section via URL</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel panel-default">
                                                ...
                                                <div id="collapse_3_4" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        ...
                                                        <p>
                                                            <a class="btn red" href="tabs_accordions_navs.php#collapse_3_4" target="_blank">Activate this section via URL</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script src="assets/plugins/bootstrap-tabdrop/js/bootstrap-tabdrop.js"></script><!-- Common js-->
