...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/css/pages/typography.css" rel="stylesheet" type="text/css"><!--bootstrap -->
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="typography.php" class="nav-link"><span class="title">Typography</span><span class="selected"></span></a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="card card-topline-green">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <h3 class="text-light full-width">
                                                Light text
                                            </h3>
                                            <h3 class="text-normal full-width">
                                                Normal text
                                            </h3>
                                            <h3 class="text-medium full-width">
                                                Medium text
                                            </h3>
                                            <h3 class="text-bold full-width">
                                                Bold text
                                            </h3>
                                            <h3 class="text-ultra-bold full-width">
                                                Ultra bold text
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <ul>
                                                ...
                                                <li>Fifth item
                                                    <ul>
                                                        <li>fifth item first subitem
                                                        </li>
                                                        <li>fifth item second subitem
                                                        </li>
                                                        <li>fifth item third subitem
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li>Sixth item
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="mg-bottom-xxl">
                                    <p>
                                        To add some emphasis to a paragraph, add class <code>.lead</code>. This will give you a larger font size, lighter weight, and a taller line height.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="mg-bottom-xxl">
                                    <p>
                                        For highlighting text <code>&lt;mark&gt;</code>tag can be a quick and easy way of highlighting or marking text on a page.
                                    </p>
                                </div>
                            </div>
                            <div class="offset-lg-1 col-md-8">
                                <div class="borderBox light bordered">
                                    <p>
                                        Pellentesque habitant morbi tristique senectus et netus et malesuada <mark>fames ac turpis egestas</mark>libero sit amet quam egestas semper. Aenean ultricies mi.
                                    </p>
                                    <p>
                                        <mark>Duis mollis, est non commodo luctus</mark>, nisi erat porttitor ligula, eget lacinia odio sem nec elit.<br>
