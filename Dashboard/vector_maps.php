...
<html lang="en">
    ...
    <head>
        ...
        <link href="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/4.3.1/css/bootstrap.min.css" rel="stylesheet" type="text/css"><!-- vector map -->
        <link href="assets/plugins/jqvmap/jqvmap.css" rel="stylesheet" type="text/css"><!-- Material Design Lite CSS -->
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
                            ...
                            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                                ...
                                <li class="nav-item active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item active">
                                            <a href="vector_maps.php" class="nav-link"><span class="title">Vector Maps</span><span class="selected"></span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
        ...
        <script src="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.min.js"></script><!-- vector map -->
        ...
        <script src="assets/js/pages/map/vector-data.js"></script><!-- Common js-->
